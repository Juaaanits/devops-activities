# DEVOPS PROJECTS
This repository contains my projects while taking the DevOps track of [roadmap.sh](https://roadmap.sh/devops).
...
5. [**SSH Remote Server Setup**](https://github.com/Juaaanits/ssh-remote-server-setup) 
...
10. [**Basic Dockerfile**](https://github.com/Juaaanits/basic-dockefile) 
11. [**Configuration Management**](https://roadmap.sh/projects/configuration-management) 
